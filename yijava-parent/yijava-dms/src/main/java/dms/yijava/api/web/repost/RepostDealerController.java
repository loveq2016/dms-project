...
public class RepostDealerController {
	...
	public JsonPage<Dealer> paging(PageRequest pageRequest,HttpServletRequest request,Model model) {
	...
	public void down(PageRequest pageRequest, HttpServletRequest request,
		   ...
		   List<PropertyFilter> filters = PropertyFilters.build(request);
		   List<Dealer> list = dealerService.paging(pageRequest,filters).getRows();
	...
	private void excel(String excelPath,List<Dealer> list,HttpServletResponse response){
		try {
	       ...
	       */
	        ...
	        for (Dealer dealer : list) {
				...
				for (int j = 0; j < 9; j++) {
                    ...
                    switch (j) {
						case 0:cellN.setCellValue(dealer.getDealer_name());break;
						case 1:cellN.setCellValue("");break;
						case 2:cellN.setCellValue(dealer.getOperated_scope());break;
						case 3:cellN.setCellValue(dealer.getDealer_code());break;
						case 4:cellN.setCellValue(dealer.getBusiness_contacts());break;
						case 5:cellN.setCellValue(dealer.getBusiness_phone());break;
						case 6:cellN.setCellValue(dealer.getInvoice_address());break;
						case 7:cellN.setCellValue(dealer.getInvoicea_postcode());break;
						default:break;
					}
				}
				row++;
