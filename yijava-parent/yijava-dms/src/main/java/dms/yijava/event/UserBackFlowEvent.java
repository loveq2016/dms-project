...
public class UserBackFlowEvent {
	...
	public UserBackFlowEvent(String user_id) {
		super();
		this.user_id = user_id;
	}


	public UserBackFlowEvent(String user_id, String user_name, String flow_id,
	...
	public String toString() {
		...
		return "UserBackFlowEvent [user_id=" + user_id + ", user_name="
