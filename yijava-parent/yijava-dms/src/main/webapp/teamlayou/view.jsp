...
<%@include file="/common/head.jsp"%>
		...
		<div id="w" class="easyui-window" title="组织分类" data-options="minimizable:false,maximizable:false,modal:true,closed:true,iconCls:'icon-manage'" style="width:300px;height:250px;padding:10px;">
