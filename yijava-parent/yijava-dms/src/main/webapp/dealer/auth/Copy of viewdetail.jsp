...
<body LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0>
				...
				<table id="dgHospital" class="easyui-datagrid" title="包含医院" style="height: 230px" method="get"
					...
					<thead>
						<tr>
							...
							<th field="provinces" width="100" align="left" sortable="true">省份</th>
    ...
    <div id="dlgProducr-buttons">
     ...
     <div id="dlgHospital" class="easyui-dialog" style="width:850px;height:560px;padding:5px 5px 5px 5px;"
            modal="true" closed="true" buttons="#dlgProducr-buttons">
