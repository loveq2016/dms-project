						...
						<form id="ffquery" method="post">
							<table>
								<tr>
									...
									<td>型号:</td>
									<td>
										<input class="easyui-combobox" type="text" name="models" id="models" data-options="required:false"></input>
									</td>
							</tr>
							<tr>
									<td>批号:</td>
									<td>
										<input class="easyui-combobox" type="text" name="batch_no" id="batch_no" data-options="required:false"></input>
									</td>
									
									<td>序列号:</td>
									<td>
										<input class="easyui-combobox" type="text" name="product_sn" id="product_sn" data-options="required:false"></input>
									</td>
