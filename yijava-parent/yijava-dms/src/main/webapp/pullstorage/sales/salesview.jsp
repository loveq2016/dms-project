										...
										<c:choose>
										       ...
										       <c:otherwise>
										       		<input class="easyui-combobox" name="dealer_id" id="dealer_id" style="width:150px" maxLength="100" class="easyui-validatebox"
								             			data-options="
									             			url:'${basePath}api/userDealerFun/api_list?t_id=${user.teams}&u_id=${user.id}',
										                    method:'get',
				...
				<table id="dg" title="查询结果" style="height:370px" method="get"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'sales_date',width:100,align:'center'" formatter="formatterdate" sortable="true">销售时间</th>
